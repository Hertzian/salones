                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="card border-secondary">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ url('/admin/newpaquetes/' . $salon->id) }}">
                            @csrf
                                <h3 class="card-title">
                                ...
                                {{-- <label for="id_salon"><small>selecciona un salon:</small></label>
                                <select class="mt-3" name="id_salon" id="id_salon">
                                    @if (count($salones) >= 1)  
